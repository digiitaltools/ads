(function() {
    // 1. Deteksi Protokol Pemanggil (http: atau https:)
    const currentProto = window.location.protocol === 'https:' ? 'https:' : 'http:';

    // 2. Injeksi CSP Upgrade secara dinamis (Hanya jika di HTTPS)
    try {
        if (currentProto === 'https:') {
            ...
            if (!existingMeta) {
                ...
                console.log("CSP Upgrade-Insecure-Requests injected for HTTPS context.");
            }
        }
    } catch (e) {
    ...
    // 3. Menyesuaikan URL Ad-Network mengikuti protokol pemanggil
    // Menggunakan format //domain agar otomatis mengikuti protokol jika memungkinkan
    const secureSrc = currentProto + "//www.highperformanceformat.com/c6519a79b77606d968cf36c00f3894c6/invoke.js";
